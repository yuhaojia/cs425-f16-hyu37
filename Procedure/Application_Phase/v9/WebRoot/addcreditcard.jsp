...
<html>
  <head>
    ...
    <title>Add credit card here.</title>
   ...
   <center>
		<form action="addcreditcard_result.jsp" method="post">
			<table bgColor="#c0c0c0">
				<tr>
					<td align="center" bgcolor=green colspan=2><font color=white>Add Credit Card</font></td>
				</tr>
				<tr>
					<td>Card Number</td>
				...
				<tr>
					<td>customerID</td>
					<td><input type="text" size=20 name="customerID"></td>
				</tr>
				<tr>
					<td>addrID</td>
					<td><input type="text" size=20 name="addrID"></td>
				</tr>
